...
__global__ void ROIPoolForward(const int n, const Dtype* bottom_data, const Dtype* bottom_rois,
	...
	CUDA_KERNEL_LOOP(idx, n){
		...
		int x1 = bottom_rois[1] * spatial_scale;
		int y1 = bottom_rois[2] * spatial_scale;
		int x2 = bottom_rois[3] * spatial_scale;
		int y2 = bottom_rois[4] * spatial_scale;
...
__global__ void ROIPoolBackward(const int n, const Dtype* top_diff, const Dtype* bottom_rois,
	...
	CUDA_KERNEL_LOOP(idx, n){
		...
		for (int n = 0; n < num_rois; n++){
			...
			int x1 = bottom_rois_off[1] * spatial_scale;
			int y1 = bottom_rois_off[2] * spatial_scale;
			int x2 = bottom_rois_off[3] * spatial_scale;
			int y2 = bottom_rois_off[4] * spatial_scale;
